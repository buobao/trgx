...
function SmartUnLoading() {
    $(".divMessageBox").fadeOut(300,
        function() {
            $(this).remove()
        });
    $(".LoadingBoxContainer").fadeOut(300,
        function() {
            $(this).remove()
        })
}
...
var BigBoxes = 0; (function($) {
    $.bigBox = function(settings, callback) {
        ...
        ThisBigBoxCloseCross.bind("click",
            function() {
...
var SmallBoxes = 0,
    ...
    $.smallBox = function(settings, callback) {
        ...
        if (settings.timeout != undefined) {
            setTimeout(function() {
                    ...
                    if ($("#" + CurrentIDSmallbox + ":hover").length != 0) {
                        $("#" + CurrentIDSmallbox).on("mouseleave",
                            function() {
        ...
        $("#smallbox" + SmallBoxes).bind("click",
            function() {
                clearInterval(ColorTimeInterval);
                if (typeof callback == "function") {
                    if (callback) {
