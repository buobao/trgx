    ...
    View = (function() {
        ...
        View.prototype.choose = function(e) {
            ...
            if (($li = this.$el.find(".cur")).length) {
               ...
               // str="<span id='comUser' style='font-weight: 200'>"+content+"</span>";f
                this.context.insert(this.context.callbacks("beforeInsert").call(this.context, content, $li), $li);
                this.context.trigger("inserted", [$li, e]);
               // console.debug("ids .>"+this.context.getOpt('chooeseIds'));
                //ÄÃµ½Ñ¡ÖÐid
                //var id=$("#chooseIds").val();
                //var selectId=this.$el.find(".cur")[0].id;
                //if(id.indexOf(selectId)==-1){
                //    id+=selectId+",";
                //}else{
                //
                //}
                //
                //$("#chooseIds").val(id);
                //console.debug($("#chat_textarea-expand"));
                this.hide(e);
            }
        ...
        View.prototype.render = function(list) {
            ...
            tpl="<li id='${id}'>${name} <small>(${mobile})</small></li>";
