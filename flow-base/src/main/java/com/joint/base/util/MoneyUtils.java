...
public class MoneyUtils {  
    ...
    */    
    public static String convertCN(String amount) throws IllegalArgumentException {    
    // 去掉分隔符    
    ...
    public static void main(String[] args) {
      ...
      System.out.println("dsfsfd="+ MoneyUtils.format(new BigDecimal("2342423423.423234234")));
      System.out.println("dsfsfd="+ MoneyUtils.formatOfRead(new BigDecimal("234242342342323423.4")));
